...
void task_fw(ak_msg_t* msg) {
	...
	case FW_CRENT_APP_FW_INFO_REQ: {
		APP_DBG("FW_CRENT_APP_FW_INFO_REQ\n");
		sys_boot_t sb;
		sys_boot_get(&sb);
	...
	case FW_CRENT_BOOT_FW_INFO_REQ: {
		APP_DBG("FW_CRENT_BOOT_FW_INFO_REQ\n");
		sys_boot_t sb;
		sys_boot_get(&sb);
	...
	case FW_PACKED_TIMEOUT: {
		APP_DBG("FW_PACKED_TIMEOUT\n");
	}
		break;

	case FW_INTERNAL_UPDATE_APP_RES_OK: {
		APP_DBG("FW_INTERNAL_UPDATE_APP_RES_OK\n");
	...
	case FW_INTERNAL_UPDATE_BOOT_RES_OK: {
		APP_DBG("FW_INTERNAL_UPDATE_BOOT_RES_OK\n");
