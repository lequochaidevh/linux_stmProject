...
void nrf_nwk_fsm_idle(ak_msg_t* msg) {
	...
	case RF24_NWK_COMMON_MSG_OUT: {
		APP_DBG("RF24_NWK_COMMON_MSG_OUT\n");
	...
	case RF24_NWK_DYNAMIC_MSG_OUT: {
		APP_DBG("RF24_NWK_DYNAMIC_MSG_OUT\n");
	}
		break;

	case RF24_NWK_DATA_MSG_OUT: {
		APP_DBG("RF24_NWK_DATA_MSG_OUT\n");
	}
		break;

	case RF24_NWK_RECV_MSG: {
		APP_DBG("RF24_NWK_RECV_MSG\n");
	...
	case RF24_NWK_SEND_MSG_DONE: {
		APP_DBG("RF24_NWK_SEND_MSG_DONE\n");
	...
	case RF24_NWK_SEND_MSG_ERR_SDF: {
		APP_DBG("RF24_NWK_SEND_MSG_ERR_SDF\n");
		/* free error nwk pdu */
		uint32_t nwk_pdu_id;
		memcpy(&nwk_pdu_id, (uint8_t*)get_data_common_msg(msg), sizeof(uint32_t));
		nrf_nwk_pdu_free(nwk_pdu_id);
	...
	case RF24_NWK_SEND_MSG_ERR_BUSY: {
		APP_DBG("RF24_NWK_SEND_MSG_ERR_BUSY\n");
