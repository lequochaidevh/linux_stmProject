...
void task_dbg(ak_msg_t* msg) {
    ...
    case AC_DBG_MORTOR_QUAY_THUAN: {
        xprintf("AC_DBG_MORTOR_QUAY_THUAN\n");
        GPIO_ResetBits(STEP_MOTOR1_DIR_PORT, STEP_MOTOR1_DIR_PIN);

//        timer_set(AC_TASK_DBG_ID, AC_DBG_MORTOR_QUAY_TRAI, 5000, TIMER_ONE_SHOT);

    }
        break;

    case AC_DBG_MORTOR_QUAY_TRAI: {
        xprintf("AC_DBG_MORTOR_QUAY_TRAI\n");
