...
/* Measurement and Sensing Clusters IoT define */
#define ZCL_CLUSTER_ID_MS_IOT_LAB_SMARTIR_DEVICE             0x5555
#define ZCL_CLUSTER_ID_MS_IOT_SOLAR_PANEL_CLEANING_ROBOT	 0x0006
#define ZCL_CLUSTER_ID_MS_IOT_LAB_TOUCH	                     21846
...
typedef struct
{
	uint32_t srcaddr;
	ZdpStatus status;
} __AK_PACKETED ZdoMgmtPermitJoinRspInd_t;
...
} __AK_PACKETED ZDO_DeviceAnnce_t;
