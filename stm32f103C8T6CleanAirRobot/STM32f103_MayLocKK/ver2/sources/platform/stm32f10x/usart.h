...
/**
 * When you initialize USARTxxx, you have to select which pins pack you will use
 *
 * 
 */
typedef enum {
 ...
 *
 * Parameters:
 * 	- USART_TypeDef* USARTxxx: which USART channel
 * 		USART1, USART2, USART3, UART4, UART5, USART6, UART7. UART8
 * 	- USART_PinsPack_t pinspack: Pinspack used
 
 *	- uint32_t baudrate: baudrate for USARTxxx
 */
extern void USARTxxx_Init(USART_TypeDef* USARTxxx, USART_PinsPack_t pinspack, uint32_t baudrate);

/**
 * Put character to USARTxxx
 *
 * Parameters:
 * 	- USART_TypeDef* USARTxxx: which USART channel
 * 		USART1, USART2, USART3, UART4, UART5, USART6, UART7. UART8
 ...
 */
extern void USART_Putc(USART_TypeDef* USARTxxx, volatile char c);

/**
 * Put string to USARTxxx
 *
 * Parameters:
 * 	- USART_TypeDef* USARTxxx: which USART channel
 * 		USART1, USART2, USART3, UART4, UART5, USART6, UART7. UART8
 ...
 */
extern void USART_Puts(USART_TypeDef* USARTxxx, char* str);
 ...
 */
extern uint8_t USART_Getc(USART_TypeDef* USARTxxx);
 ...
 */
extern uint16_t USART_Gets(USART_TypeDef* USARTxxx, char* buffer, uint16_t bufsize);
 ...
 */
extern uint8_t USART_FindCharacter(USART_TypeDef* USARTxxx, volatile char c);
 ...
 */
extern uint8_t USART_BufferEmpty(USART_TypeDef* USARTxxx);
 ...
 */
extern uint8_t USART_BufferFull(USART_TypeDef* USARTxxx);
 ...
 * No return
 */
extern void USART_ClearBuffer(USART_TypeDef* USARTxxx);
 ...
 */
extern void USART1_ReceiveHandler(uint8_t c);
extern void USART2_ReceiveHandler(uint8_t c);
extern void USART3_ReceiveHandler(uint8_t c);
extern void UART4_ReceiveHandler(uint8_t c);
extern void UART5_ReceiveHandler(uint8_t c);
extern void USART6_ReceiveHandler(uint8_t c);
extern void UART7_ReceiveHandler(uint8_t c);
extern void UART8_ReceiveHandler(uint8_t c);
