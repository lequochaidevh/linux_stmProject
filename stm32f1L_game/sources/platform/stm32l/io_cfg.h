 ...
 *Pin map led life
******************************************************************************/
#define LED_LIFE_IO_PIN					(GPIO_Pin_1)
 ...
 *Pin map Flash W2508
******************************************************************************/
#define FLASH_CE_IO_PIN					(GPIO_Pin_4)
#define FLASH_CE_IO_PORT				(GPIOA)
#define FLASH_CE_IO_CLOCK				(RCC_AHBPeriph_GPIOA)
...
extern void buzzer_io_on();
extern void buzzer_io_off();

/*****************************************************************************
 *io pwm timer 3 for Buzzer
******************************************************************************/
extern void io_pwm_timer3_cfg();
extern void io_pwm_timer3_enable();
extern void io_pwm_timer3_disable();
extern void io_pwm_timer3_chanel_enable(uint8_t);
extern void io_pwm_timer3_chanel_disable(uint8_t);
extern void io_pwm_timer3_set_duty_cycle(uint8_t, uint16_t);
